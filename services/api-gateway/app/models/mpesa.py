...
class MpesaStkRequest(AuditMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("checkout_request_id", name="uq_mpesa_stk_checkout_request_id"),
    ...
    merchant_request_id: Mapped[str] = mapped_column(String(100), nullable=False, default="")
