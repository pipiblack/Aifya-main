...
class SmsDeliveryLog(AuditMixin, Base):
    ...
    campaign_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("sms_campaigns.id"))
    ...
    cost: Mapped[Decimal] = mapped_column(Numeric(8, 4), nullable=False, default=Decimal("0"))
